...
public class TestJoglGPGPUBase
    ...
    public TestJoglGPGPUBase(final ShaderManager theShaderManager,
        ...
        _myShaderManager.attachVertexShader(_myShaderProgram, Resource.getStream("source/data/demo/shader/gpgpu/GPGPU3DParticle.vs"));
        _myShaderManager.attachFragmentShader(_myShaderProgram, Resource.getStream("source/data/demo/shader/gpgpu/GPGPU3DParticle.fs"));
    }
