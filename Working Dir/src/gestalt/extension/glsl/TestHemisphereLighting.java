...
public class TestHemisphereLighting
    ...
    public void setup() {
        ...
        _myShaderManager.attachVertexShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/hemispherelight.vsh"));
        _myShaderManager.attachFragmentShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/hemispherelight.fsh"));
