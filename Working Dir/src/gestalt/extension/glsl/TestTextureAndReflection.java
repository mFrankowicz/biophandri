...
public class TestTextureAndReflection
    ...
    public void setup() {
        ...
        myShaderManager.attachVertexShader(myShaderProgram, Resource.getStream("resource/data/demo/shader/texreflection.vsh"));
        myShaderManager.attachFragmentShader(myShaderProgram, Resource.getStream("resource/data/demo/shader/texreflection.fsh"));

        ShaderMaterial _myShaderMaterial = new ShaderMaterial(myShaderManager, myShaderProgram);

        /* model */
        ModelData myModelData = ModelLoaderOBJ.getModelData(Resource.getStream("resource/data/demo/common/occlusioncube.obj"));
        ...
        myTexture0.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/occlusion.png")));
        ...
        _myCubeMap.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_negx.png")),
                        Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_posx.png")),
                        Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_negy.png")),
                        Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_posy.png")),
                        Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_negz.png")),
                        Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/cube_posz.png")));
