...
public class TestBumpMappingGLSL
    ...
    public void setup() {
        ...
        myShaderManager.attachVertexShader(myShaderProgram, Resource.getStream("resource/data/demo/shader/normalmap.vsh"));
        myShaderManager.attachFragmentShader(myShaderProgram, Resource.getStream("resource/data/demo/shader/normalmap.fsh"));
        ...
        myNormalMap.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/normal_map3.png")));
        ...
        myColorMap.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/color_map3.png")));
