...
public class TestModularShader
    ...
    public void setup() {
        ...
        _myShaderManager.attachVertexShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/simple.vsh"));
         ...
         * }
         */
        _myShaderManager.attachFragmentShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/f01.fsh"));
        _myShaderManager.attachFragmentShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/f02.fsh"));
    ...
    private Model createModel() {
        ...
        myModelData = ModelLoaderOBJ.getModelData(Resource.getStream("resource/data/demo/common/weirdobject.obj"));
