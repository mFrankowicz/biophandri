...
public class Using3DTexture
    ...
    public void setup() {
        ...
        myPlane.material().addTexture().load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/auto.png")));
        ...
        /* load movie */
        MovieProducer myMovieProducer = Bitmaps.getMovieProducer(Resource.getPath("resource/data/demo/common/subway.mov"));
