...
public class UsingOBJModelLoader
    ...
    public void setup() {
         ...
         * ModelLoaderOBJ
         */
        ModelData myModelData = ModelLoaderOBJ.getModelData(Resource.getStream("resource/data/demo/common/explosion.obj"));
        ...
        myTexture.load(Bitmaps.getBitmap(Resource.getPath("resource/data/demo/common/vignet.png")));
