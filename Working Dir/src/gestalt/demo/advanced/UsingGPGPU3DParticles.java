...
public class UsingGPGPU3DParticles
    ...
    public void setup() {
        ...
        /* setup heightmap  */
        Plane myHeightfieldBase = G.plane(myHeightfield.bin(), Resource.getStream("resource/data/demo/common/gpgpuheightfield.png"));
        ...
        _mySimulation = new GPGPU3DParticlesSimulation(_myShaderManager,
                                                       ...
                                                       width, height,
                                                       myHeightfield,
                                                       "resource/data/demo/shader/gpgpu/GPGPU3DParticle.vs",
                                                       "resource/data/demo/shader/gpgpu/GPGPU3DParticle.fs");
        ...
        ParticleResetterRandom myResetter = new ParticleResetterRandom(_myShaderManager,
                                                                       ...
                                                                       "resource/data/demo/shader/gpgpu/GPGPUParticleReset.fs");
        ...
        myPointSprites.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/particle.png")));
