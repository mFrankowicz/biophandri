...
public class UsingMultiTexturing
    ...
    private class MultiTexturedPlane
        ...
        public MultiTexturedPlane() {
            ...
            _myImageTexture.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/auto.png")));

            /* mask texture */
            _myMaskTexture = (TexturePlugin) drawablefactory().texture();
            _myMaskTexture.setFilterType(TEXTURE_FILTERTYPE_LINEAR);
            _myMaskTexture.load(Bitmaps.getBitmap(Resource.getStream("resource/data/demo/common/mask256.png")));
        }
