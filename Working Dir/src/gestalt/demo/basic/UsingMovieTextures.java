...
public class UsingMovieTextures
    ...
    public void setup() {
         ...
         */
        _myMovieProducer = Bitmaps.getMovieProducer(Resource.getPath("resource/data/demo/common/movie.mov"), false);
        ...
        _mySecondMovieProducer = Bitmaps.getMovieProducer(Resource.getPath("resource/data/demo/common/movie.mov"));
