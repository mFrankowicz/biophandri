...
public class UsingGLSLShader
    ...
    public void setup() {
		...
		_myShaderManager.attachVertexShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/toon.vsh"));

		_myShaderManager.attachFragmentShader(_myShaderProgram, Resource.getStream("resource/data/demo/shader/toon.fsh"));
